...
(function() {
	...
	// Initialize scroll tracking.
		scrollTracking.add('.container-component.style-3');
		scrollTracking.add('.container-component.style-4');
	
	// Initialize "On Visible" animations.
		onvisible.add('.image-component.instance-1', { style: 'fade-down', speed: 750, intensity: 4, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-15', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-21', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.style-1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.text-component.style-14', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-22', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-20', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.text-component.style-13', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-18', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-14', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-23', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-17', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.image-component.instance-3', { style: 'fade-down', speed: 750, intensity: 4, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-24', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.text-component.style-5', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: true });
		onvisible.add('.text-component.style-12', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-9', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-10', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.text-component.style-2', { style: 'fade-left', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-4', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-6', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-16', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-6', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.style-2', { style: 'fade-in-background', speed: 2500, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.instance-2', { style: 'fade-down', speed: 750, intensity: 4, threshold: 3, delay: 0, replay: true });
		onvisible.add('.buttons-component.style-6', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-3', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.image-component.instance-9', { style: 'fade-down', speed: 750, intensity: 4, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-25', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-19', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons-component.style-5', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.icons-component.instance-4', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-11', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: true });
		onvisible.add('.icons-component.instance-2', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons-component.style-1', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-30', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-11', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-7', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-8', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-3', { style: 'fade-left', speed: 750, intensity: 1, threshold: 3, delay: 375, replay: true });
		onvisible.add('.icons-component.instance-5', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-13', { style: 'fade-up', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.container-component.instance-13', { style: 'fade-in-background', speed: 2500, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.text-component.style-7', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-1', { style: 'fade-in-background', speed: 2500, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-26', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-27', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-4', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container-component.instance-14', { style: 'fade-in-background', speed: 2500, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-28', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('.divider-component.instance-29', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
