...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('.divider-component.instance-19', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-9', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		onvisible.add('.divider-component.instance-31', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: true });
		...
		onvisible.add('.divider-component.instance-1', { style: 'fade-in', speed: 1000, intensity: 5, threshold: 3, delay: 0, replay: false });
